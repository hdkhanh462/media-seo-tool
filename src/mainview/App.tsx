...
function App() {
  return (
    <SidebarInset>
      <div className="flex max-h-[calc(100vh-var(--header-height))] max-w-[calc(100vw-var(--container-md)-var(--sidebar-width-icon))] flex-1 flex-col gap-4 overflow-y-auto p-4">
